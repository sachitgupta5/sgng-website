...
const serviceData = {
  ...
  'business-automation-ai-advisory': {
    ...
    tagline: 'AI-powered automation solutions for accounting, compliance, and business processes.',
    overview:
      'We help businesses harness the power of Artificial Intelligence and automation to streamline financial operations, reduce manual effort, and gain real-time insights. Our AI advisory practice combines deep domain expertise in accounting and compliance with cutting-edge technology solutions.',
    sections: [
      {
        heading: 'AI Strategy & Consulting',
        items: [
          'AI readiness assessment for your business',
          'Custom AI roadmap and implementation plan',
      ...
      {
        heading: 'Accounting & Finance Automation',
        items: [
      ...
      {
        heading: 'Tax & Compliance Automation',
        items: [
          'Automated GST return preparation and filing',
          'AI-driven tax computation and optimization',
          'Compliance calendar automation with alerts',
          'Automated TDS computation and return filing',
      ...
      },
      {
        ...
        items: [
          ...
          'Data extraction and migration automation',
      ...
      {
        heading: 'AI-Powered Analytics & Reporting',
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          'Intelligent search across financial documents',
        ],
      },
    ],
  },
